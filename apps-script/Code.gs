...
var SHEETS = {
  ...
  tasks: [
    ...
    "parent_recurring_id", "main_assignee_id", "support_assignee_ids", "due_date",
    "status", "completed_at", "is_overdue_recorded", "created_by", "created_at", "updated_at",
  ],
  task_notes: ["id", "task_id", "member_id", "content", "created_at"],
  extension_requests: [
...
var JSON_FIELDS = ["recurrence_rule", "support_assignee_ids"];
// Các cột boolean
var BOOL_FIELDS = ["is_active", "is_overdue_recorded"];
